 ...
 */
class wp_sm_navwalker extends Walker_Nav_Menu {
...
function sm_custom_walker($args) {
    if ('' == $args['theme_location']) {

        if (is_rtl()) {
            $mnuclass = 'sm sm-rtl elemenu';
        } else {
            $mnuclass = 'sm elemenu';
        }
        $bSwalker = new wp_sm_navwalker();

        $args['container'] = 'nav';
        $args['container_class'] = 'elementor-icon-list-text';
...
//add_filter('wp_nav_menu_args', 'sm_custom_walker');
